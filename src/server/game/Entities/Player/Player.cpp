...
void Player::_SaveStats(SQLTransaction& trans)
{
    ...
    ss << GetFloatValue(PLAYER_DODGE_PERCENTAGE) << ',';
    ss << GetFloatValue(PLAYER_PARRY_PERCENTAGE) << ',';
	ss << GetFloatValue(PLAYER_CRIT_PERCENTAGE) << ',';
    ss << GetFloatValue(PLAYER_RANGED_CRIT_PERCENTAGE) << ',';
    ss << GetFloatValue(PLAYER_SPELL_CRIT_PERCENTAGE1) << ',';
    ss << GetUInt32Value(UNIT_FIELD_ATTACK_POWER) << ',';
    ss << GetUInt32Value(UNIT_FIELD_RANGED_ATTACK_POWER) << ',';
    ss << GetBaseSpellPowerBonus() << ')';
    trans->Append(ss.str().c_str());
}
